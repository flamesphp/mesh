...
use Flames\Mesh\Error\LoaderError;
use Flames\Mesh\Error\RuntimeError;
use Flames\Mesh\ExpressionParser;
use Flames\Mesh\Markup;
use Flames\Mesh\Node\Expression\Binary\AddBinary;
use Flames\Mesh\Node\Expression\Binary\AndBinary;
use Flames\Mesh\Node\Expression\Binary\BitwiseAndBinary;
use Flames\Mesh\Node\Expression\Binary\BitwiseOrBinary;
use Flames\Mesh\Node\Expression\Binary\BitwiseXorBinary;
use Flames\Mesh\Node\Expression\Binary\ConcatBinary;
use Flames\Mesh\Node\Expression\Binary\DivBinary;
use Flames\Mesh\Node\Expression\Binary\EndsWithBinary;
use Flames\Mesh\Node\Expression\Binary\EqualBinary;
use Flames\Mesh\Node\Expression\Binary\FloorDivBinary;
use Flames\Mesh\Node\Expression\Binary\GreaterBinary;
use Flames\Mesh\Node\Expression\Binary\GreaterEqualBinary;
use Flames\Mesh\Node\Expression\Binary\HasEveryBinary;
use Flames\Mesh\Node\Expression\Binary\HasSomeBinary;
use Flames\Mesh\Node\Expression\Binary\InBinary;
use Flames\Mesh\Node\Expression\Binary\LessBinary;
use Flames\Mesh\Node\Expression\Binary\LessEqualBinary;
use Flames\Mesh\Node\Expression\Binary\MatchesBinary;
use Flames\Mesh\Node\Expression\Binary\ModBinary;
use Flames\Mesh\Node\Expression\Binary\MulBinary;
use Flames\Mesh\Node\Expression\Binary\NotEqualBinary;
use Flames\Mesh\Node\Expression\Binary\NotInBinary;
use Flames\Mesh\Node\Expression\Binary\OrBinary;
use Flames\Mesh\Node\Expression\Binary\PowerBinary;
use Flames\Mesh\Node\Expression\Binary\RangeBinary;
use Flames\Mesh\Node\Expression\Binary\SpaceshipBinary;
use Flames\Mesh\Node\Expression\Binary\StartsWithBinary;
use Flames\Mesh\Node\Expression\Binary\SubBinary;
use Flames\Mesh\Node\Expression\Filter\DefaultFilter;
use Flames\Mesh\Node\Expression\NullCoalesceExpression;
use Flames\Mesh\Node\Expression\Test\ConstantTest;
use Flames\Mesh\Node\Expression\Test\DefinedTest;
use Flames\Mesh\Node\Expression\Test\DivisiblebyTest;
use Flames\Mesh\Node\Expression\Test\EvenTest;
use Flames\Mesh\Node\Expression\Test\NullTest;
use Flames\Mesh\Node\Expression\Test\OddTest;
use Flames\Mesh\Node\Expression\Test\SameasTest;
use Flames\Mesh\Node\Expression\Unary\NegUnary;
use Flames\Mesh\Node\Expression\Unary\NotUnary;
use Flames\Mesh\Node\Expression\Unary\PosUnary;
use Flames\Mesh\NodeVisitor\MacroAutoImportNodeVisitor;
use Flames\Mesh\Source;
...
use Flames\Mesh\TokenParser\EmbedTokenParser;
use Flames\Mesh\TokenParser\ExtendsTokenParser;
use Flames\Mesh\TokenParser\FlushTokenParser;
use Flames\Mesh\TokenParser\ForTokenParser;
use Flames\Mesh\TokenParser\FromTokenParser;
use Flames\Mesh\TokenParser\IfTokenParser;
use Flames\Mesh\TokenParser\ImportTokenParser;
use Flames\Mesh\TokenParser\ExportTokenParser;
use Flames\Mesh\TokenParser\IncludeTokenParser;
use Flames\Mesh\TokenParser\MacroTokenParser;
use Flames\Mesh\TokenParser\SetTokenParser;
use Flames\Mesh\TokenParser\UseTokenParser;
use Flames\Mesh\TokenParser\WithTokenParser;
...
final class CoreExtension extends AbstractExtension
{
     ...
     * @param string $type              The type of attribute (@see \Mesh\Template constants)
    ...
    public static function getAttribute(Environment $env, Source $source, $object, $item, array $arguments = [], $type = /* Template::ANY_CALL */ 'any', $isDefinedTest = false, $ignoreStrictCheck = false, $sandboxed = false, int $lineno = -1)
    {
        ...
        if ($object instanceof Template) {
            throw new RuntimeError('Accessing \Mesh\Template attributes is forbidden.', $lineno, $source);
        }
