...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use Flames\Mesh\Environment;\n")
                ->write("use Flames\Mesh\Error\LoaderError;\n")
                ->write("use Flames\Mesh\Error\RuntimeError;\n")
                ->write("use Flames\Mesh\Extension\CoreExtension;\n")
                ->write("use Flames\Mesh\Extension\SandboxExtension;\n")
                ->write("use Flames\Mesh\Markup;\n")
                ->write("use Flames\Mesh\Sandbox\SecurityError;\n")
                ->write("use Flames\Mesh\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use Flames\Mesh\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use Flames\Mesh\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use Flames\Mesh\Source;\n")
                ->write("use Flames\Mesh\Template;\n\n")
            ;
        }
        $compiler
