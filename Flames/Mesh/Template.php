...
abstract class Template
{
    ...
    public function yield(array $context, array $blocks = []): iterable
    {
        ...
        try {
            ...
            // this is mostly useful for \Mesh\Error\LoaderError exceptions
            // see \Mesh\Error\LoaderError
    ...
    public function yieldBlock($name, array $context, array $blocks = [], $useBlocks = true, ?self $templateContext = null)
    {
        ...
        if (null !== $template && !$template instanceof self) {
            throw new \LogicException('A block must be a method on a \Mesh\Template instance.');
        }
