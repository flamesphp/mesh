...
use Flames\Mesh\Client\Polyfill;
use Flames\Mesh\Error\Error;
use Flames\Mesh\Error\LoaderError;
use Flames\Mesh\Error\RuntimeError;
use Flames\Mesh\Error\SyntaxError;
use Flames\Mesh\Extension\CoreExtension;
use Flames\Mesh\Extension\EscaperExtension;
use Flames\Mesh\Extension\ExtensionInterface;
use Flames\Mesh\Extension\OptimizerExtension;
use Flames\Mesh\Extension\PhpSyntaxExtension;
use Flames\Mesh\Extension\YieldNotReadyExtension;
use Flames\Mesh\Loader\ArrayLoader;
use Flames\Mesh\Loader\ChainLoader;
use Flames\Mesh\Loader\LoaderInterface;
...
use Flames\Mesh\RuntimeLoader\RuntimeLoaderInterface;
...
class Environment
{
    ...
    private $templateClassPrefix = '__MeshMesh_';
     ...
     *           a \Mesh\Cache\CacheInterface implementation,
    ...
    public function __construct(LoaderInterface $loader, $options = [])
    {
        ...
        $this->addExtension(new PhpSyntaxExtension());
    }
    ...
    public function setCache($cache)
    {
        if (\is_string($cache)) {
            ...
            throw new \LogicException('Cache can only be a string, false, or a \Mesh\Cache\CacheInterface implementation.');
        }
    }
     ...
     *
     * Similar to load() but it also accepts instances of \Mesh\Template and
     * \Mesh\TemplateWrapper, and an array of templates where each is tried to be loaded.
     *
