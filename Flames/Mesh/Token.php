...
final class Token
{
    ...
    {
        return self::typeToString($this->type, true) . '(' . $this->value . ')';
    }
     ...
     */
    public function test(int|string|array $type, string|array|null $values = null): bool
    {
        ...
        if (\is_array($values)) {
            return \in_array($this->value, $values, false);
        }
